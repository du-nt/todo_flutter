...
extension TodoIsarQueryFilter
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterFilterCondition> completedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoIsarQuerySortBy on QueryBuilder<TodoIsar, TodoIsar, QSortBy> {
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completed', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> sortByCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoIsarQuerySortThenBy
  ...
  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completed', Sort.asc);
    });
  }

  QueryBuilder<TodoIsar, TodoIsar, QAfterSortBy> thenByCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completed', Sort.desc);
    });
  }
...
extension TodoIsarQueryWhereDistinct
  ...
  QueryBuilder<TodoIsar, TodoIsar, QDistinct> distinctByCompleted() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoIsarQueryProperty
  ...
  QueryBuilder<TodoIsar, bool, QQueryOperations> completedProperty() {
    return QueryBuilder.apply(this, (query) {
